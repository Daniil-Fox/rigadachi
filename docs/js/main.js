...
/* harmony import */ var _utils_strToHtml_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/strToHtml.js */ "./node_modules/@fancyapps/ui/dist/utils/strToHtml.js");
/*! License details at fancyapps.com/license */
const n=(t,e={})=>{const o=new URL(t),n=new URLSearchParams(o.search),i=new URLSearchParams;for(const[t,o]of[...n,...Object.entries(e)]){let e=o+"";if("t"===t){let t=e.match(/((\d*)m)?(\d*)s?/);t&&i.set("start",60*parseInt(t[2]||"0")+parseInt(t[3]||"0")+"")}else i.set(t,e)}let l=i+"",s=t.match(/#t=((.*)?\d+s)/);return s&&(l+=`#t=${s[1]}`),l},i={autoplay:!1,html5videoTpl:'<video class="f-html5video" playsinline controls controlsList="nodownload" poster="{{poster}}">\n    <source src="{{src}}" type="{{format}}" />Sorry, your browser doesn\'t support embedded videos.</video>',iframeAttr:{allow:"autoplay; fullscreen",scrolling:"auto",credentialless:""},vimeo:{byline:1,color:"00adef",controls:1,dnt:1,muted:0},youtube:{controls:1,enablejsapi:1,nocookie:1,rel:0,fs:1}},l=()=>{let l,s=!1;function a(){const e=null==l?void 0:l.getOptions().Video;return (0,_utils_isPlainObject_js__WEBPACK_IMPORTED_MODULE_0__.isPlainObject)(e)?Object.assign(Object.assign({},i),e):i}function c(){var t;return null===(t=null==l?void 0:l.getPage())||void 0===t?void 0:t.slides[0]}const d=t=>{var e;try{let o=JSON.parse(t.data);if("https://player.vimeo.com"===t.origin){if("ready"===o.event)for(let o of Array.from((null===(e=null==l?void 0:l.getContainer())||void 0===e?void 0:e.getElementsByClassName("f-iframe"))||[]))o instanceof HTMLIFrameElement&&o.contentWindow===t.source&&(o.dataset.ready="true")}else if(t.origin.match(/^https:\/\/(www.)?youtube(-nocookie)?.com$/)&&"onReady"===o.event){const t=document.getElementById(o.id);t&&(t.dataset.ready="true")}}catch(t){}};function r(t,o){const i=o.src;if(!(0,_utils_isString_js__WEBPACK_IMPORTED_MODULE_1__.isString)(i))return;let l=o.type;if(!l||"html5video"===l){const t=i.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i);t&&(l="html5video",o.html5videoFormat=o.html5videoFormat||"video/"+("ogv"===t[1]?"ogg":t[1]))}if(!l||"youtube"===l){const t=i.match(/(youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(?:watch\?(?:.*&)?v=|v\/|u\/|shorts\/|embed\/?)?(videoseries\?list=(?:.*)|[\w-]{11}|\?listType=(?:.*)&list=(?:.*))(?:.*)/i);if(t){const e=Object.assign(Object.assign({},a().youtube),o.youtube||{}),s=`www.youtube${e.nocookie?"-nocookie":""}.com`,c=n(i,e),d=encodeURIComponent(t[2]);o.videoId=d,o.src=`https://${s}/embed/${d}?${c}`,o.thumb=o.thumb||`https://i.ytimg.com/vi/${d}/mqdefault.jpg`,l="youtube"}}if(!l||"vimeo"===l){const t=i.match(/^.+vimeo.com\/(?:\/)?([\d]+)((\/|\?h=)([a-z0-9]+))?(.*)?/);if(t){const e=Object.assign(Object.assign({},a().vimeo),o.vimeo||{}),s=n(i,e),c=encodeURIComponent(t[1]),d=t[4]||"";o.videoId=c,o.src=`https://player.vimeo.com/video/${c}?${d?`h=${d}${s?"&":""}`:""}${s}`,l="vimeo"}}o.type=l}function m(t,n){"html5video"===n.type&&function(t){if(!l||!t.el||!t.src)return;const{el:n,src:i}=t;if(!n||!i)return;const s=t.html5videoTpl||a().html5videoTpl,c=t.html5videoFormat||a().html5videoFormat;if(!s)return;const d=t.poster||(t.thumb&&(0,_utils_isString_js__WEBPACK_IMPORTED_MODULE_1__.isString)(t.thumb)?t.thumb:""),r=(0,_utils_strToHtml_js__WEBPACK_IMPORTED_MODULE_2__.stringToHtml)(s.replace(/\{\{src\}\}/gi,i+"").replace(/\{\{format\}\}/gi,c||"").replace(/\{\{poster\}\}/gi,d+""));if(!r)return;const m=document.createElement("div");if(m.classList.add("f-html"),m.append(r),t.width){let e=`${t.width}`;e.match(/^\d+$/)&&(e+="px"),m.style.maxWidth=`${e}`}if(t.height){let e=`${t.height}`;e.match(/^\d+$/)&&(e+="px"),m.style.maxHeight=`${e}`}if(t.aspectRatio){const e=n.getBoundingClientRect();m.style.aspectRatio=`${t.aspectRatio}`,m.style[e.width>e.height?"width":"height"]="auto"}t.contentEl=r,t.htmlEl=m,n.classList.add(`has-${t.type}`),n.prepend(m),l.emit("contentReady",t)}(n),"youtube"!==n.type&&"vimeo"!==n.type||function(t){if(!l||!t.el||!t.src)return;const e=document.createElement("iframe");e.classList.add("f-iframe"),e.setAttribute("id",`f-iframe_${t.videoId}`);for(const[t,o]of Object.entries(a().iframeAttr||{}))e.setAttribute(t,o);e.onload=()=>{var o;l&&1===l.getState()&&"youtube"===t.type&&(null===(o=e.contentWindow)||void 0===o||o.postMessage(JSON.stringify({event:"listening",id:e.getAttribute("id")}),"*"))},e.onerror=()=>{l&&1===l.getState()&&(null==l||l.showError(t,"{{IFRAME_ERROR}}"))},e.src=t.src;const o=document.createElement("div");if(o.classList.add("f-html"),o.append(e),t.width){let e=`${t.width}`;e.match(/^\d+$/)&&(e+="px"),o.style.maxWidth=`${e}`}if(t.height){let e=`${t.height}`;e.match(/^\d+$/)&&(e+="px"),o.style.maxHeight=`${e}`}if(t.aspectRatio){const e=t.el.getBoundingClientRect();o.style.aspectRatio=`${t.aspectRatio}`,o.style[e.width>e.height?"width":"height"]="auto",o.style[e.width>e.height?"maxWidth":"maxHeight"]="none"}t.contentEl=e,t.htmlEl=o,t.el.classList.add("has-html"),t.el.classList.add("has-iframe"),t.el.classList.add(`has-${t.type}`),t.el.prepend(o),l.emit("contentReady",t)}(n)}function u(t,e){var o,n;"html5video"!==e.type&&"youtube"!==e.type&&"vimeo"!==e.type||(null===(o=e.contentEl)||void 0===o||o.remove(),e.contentEl=void 0,null===(n=e.htmlEl)||void 0===n||n.remove(),e.htmlEl=void 0),e.poller&&clearTimeout(e.poller)}function h(){s=!1}function f(){if(s)return;s=!0;const t=c();(t&&void 0!==t.autoplay?t.autoplay:a().autoplay)&&(function(){var t;const e=c(),o=null==e?void 0:e.el;if(o&&"html5video"===(null==e?void 0:e.type))try{const t=o.querySelector("video");if(t){const e=t.play();void 0!==e&&e.then((()=>{})).catch((e=>{t.muted=!0,t.play()}))}}catch(t){}const n=null==e?void 0:e.htmlEl;n instanceof HTMLIFrameElement&&(null===(t=n.contentWindow)||void 0===t||t.postMessage('{"event":"command","func":"stopVideo","args":""}',"*"))}(),function(){const t=c(),e=null==t?void 0:t.type;if(!(null==t?void 0:t.el)||"youtube"!==e&&"vimeo"!==e)return;const o=()=>{if(t.contentEl&&t.contentEl instanceof HTMLIFrameElement&&t.contentEl.contentWindow){let e;if("true"===t.contentEl.dataset.ready)return e="youtube"===t.type?{event:"command",func:"playVideo"}:{method:"play",value:"true"},e&&t.contentEl.contentWindow.postMessage(JSON.stringify(e),"*"),void(t.poller=void 0);"youtube"===t.type&&(e={event:"listening",id:t.contentEl.getAttribute("id")},t.contentEl.contentWindow.postMessage(JSON.stringify(e),"*"))}t.poller=setTimeout(o,250)};o()}())}return{init:function(t){l=t,l.on("addSlide",r),l.on("attachSlideEl",m),l.on("detachSlideEl",u),l.on("ready",f),l.on("change",h),l.on("settle",f),window.addEventListener("message",d)},destroy:function(){null==l||l.off("addSlide",r),null==l||l.off("attachSlideEl",m),null==l||l.off("detachSlideEl",u),null==l||l.off("ready",f),null==l||l.off("change",h),null==l||l.off("settle",f),window.removeEventListener("message",d),l=void 0}}};
...
/* harmony import */ var _components_infra_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/infra.js */ "./src/js/components/infra.js");
...
(0,_components_header_js__WEBPACK_IMPORTED_MODULE_3__.initHeader)();
(0,_components_slider_js__WEBPACK_IMPORTED_MODULE_4__.initAllSliders)();
...
function initHeader() {
  ...
  const f = (0,_functions_throttle_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(checkTop, 50);
  if (header) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initInfraCards: () => (/* binding */ initInfraCards)
/* harmony export */ });
function initInfraCards() {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initAllSliders: () => (/* binding */ initAllSliders)
/* harmony export */ });
...
const initAllSliders = () => {
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".infra__slider", {
    slidesPerView: "auto",
    spaceBetween: 20,
    navigation: {
      prevEl: ".infra-prev",
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".history__slider", {
    slidesPerView: "auto",
    spaceBetween: 20,
    navigation: {
      prevEl: ".history-prev",
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".arch__slider", {
    slidesPerView: "auto",
    spaceBetween: 20,
    navigation: {
      prevEl: ".arch-prev",
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".benefits__slider", {
    slidesPerView: "auto",
    spaceBetween: 20,
    navigation: {
  ...
  if (modalBuild.length > 0) {
    modalBuild.forEach(modal => {
      ...
      const thumbs = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(sliderThumbs, {
        slidesPerView: "auto",
        spaceBetween: 12
      });
      const mainsl = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(sliderMain, {
        slidesPerView: 1,
        spaceBetween: 20,
        thumbs: {
          swiper: thumbs
